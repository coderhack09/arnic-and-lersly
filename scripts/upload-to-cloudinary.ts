 ...
 *
 * Usage:
 *   pnpm upload:cloudinary --project "arjay and aileen"
 *   pnpm upload:cloudinary --project "arjay and aileen" --source public
 *   pnpm upload:cloudinary --project "arjay and aileen" --overwrite
 *   pnpm upload:cloudinary --project "arjay and aileen" --dry-run
 *   pnpm upload:cloudinary --project "arjay and aileen" --json-out uploads.json
 *
 ...
 *
 * "Arjay and Aileen" → "arjay-and-aileen"
 ...
 *   → "wedding-projects/arjay-and-aileen/mobile-background/couple (1)"
 */
  ...
  if (!opts.project) {
    console.error(
      "❌  No project name supplied.\n" +
        '    Usage: pnpm upload:cloudinary --project "arjay and aileen"'
    )
    process.exit(1)
  }
